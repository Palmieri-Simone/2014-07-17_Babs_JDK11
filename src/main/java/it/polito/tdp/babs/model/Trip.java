...
public class Trip {
	...
	private Date startDate ; //start date of trip with date and time, in PST
	private String startStation ; //station name of start station
	private int startTerminal ; //numeric reference for start station
	private Date endDate ; //end date of trip with date and time, in PST
	...
	public Trip(int tripId, int duration, Date startDate, String startStation,
			int startTerminal, Date endDate, String endStation,
